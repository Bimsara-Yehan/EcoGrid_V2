...
ENERGY_MODEL_PATH = os.path.join(MODELS_DIR, os.getenv("AI_ENERGY_MODEL", "energy_v1_working.joblib"))
EMISS_MODEL_PATH = os.path.join(MODELS_DIR, os.getenv("AI_EMISS_MODEL", "emissions_v1_working.joblib"))
...
energy_model = _safe_load_model(ENERGY_MODEL_PATH)
emiss_model = _safe_load_model(EMISS_MODEL_PATH)
